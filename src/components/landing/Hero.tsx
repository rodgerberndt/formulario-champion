...
export function Hero() {
  ...
  return <section className="min-h-[80vh] md:min-h-screen flex items-center justify-center pt-16 pb-16 md:pb-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <Trophy className="hidden md:block absolute top-[15%] left-[8%] w-6 h-6 text-secondary/10 animate-float" style={{
        animationDelay: "0s"
      }} />
        <Trophy className="absolute top-[25%] right-[12%] w-5 h-5 text-secondary/8 animate-float" style={{
        animationDelay: "1s"
      }} />
        <Trophy className="hidden md:block absolute top-[60%] left-[5%] w-7 h-7 text-secondary/8 animate-float" style={{
        animationDelay: "2s"
      }} />
        <Trophy className="absolute top-[70%] right-[8%] w-5 h-5 text-secondary/10 animate-float" style={{
        animationDelay: "0.5s"
      }} />
        <Trophy className="hidden lg:block absolute top-[40%] left-[15%] w-4 h-4 text-secondary/6 animate-float" style={{
        animationDelay: "1.5s"
      }} />
        <Trophy className="hidden lg:block absolute top-[50%] right-[20%] w-6 h-6 text-secondary/6 animate-float" style={{
        animationDelay: "2.5s"
      }} />
      </div>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 md:gap-10 items-center">
            ...
            <div className="text-center md:text-left order-2 md:order-1">
              ...
              {/* Subheadline */}
              <p className="text-sm md:text-base text-muted-foreground max-w-sm mx-auto md:mx-0 mb-6 animate-slide-up" style={{
              ...
              {/* Micro Proofs */}
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 md:gap-6 text-muted-foreground animate-fade-in" style={{
            ...
            <div className="flex justify-center md:justify-end order-1 md:order-2 animate-fade-in">
              <div className="relative">
                ...
                <img src={founderPhoto} alt="Founder" className="relative w-56 h-56 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 object-contain drop-shadow-2xl" loading="eager" />
              </div>
            </div>
          </div>
        </div>
