            ...
            <div className="text-center md:text-left order-2 md:order-1">
              ...
              <div className="flex flex-col items-center md:items-start gap-4 mb-8">
                <Button 
                  ...
                  className="group h-12 md:h-14 px-6 md:px-8 text-sm md:text-base font-semibold bg-primary hover:bg-primary/90 text-primary-foreground rounded-2xl shadow-xl shadow-primary/25 hover:shadow-2xl hover:shadow-primary/35 transition-shadow duration-200 active:scale-[0.98]"
                >
